...
#										  _____  __  __                    __ __               
#										 / ___ \/ /_/ /  ___   _______ ___/ // /____ ___ ___ _ 
#										/ / _ `/ __/ _ \/ -_) / __/ -_) _  // __/ -_) _ `/  ' \
#										\ \_,_/\__/_//_/\__(_)_/  \__/\_,_(_)__/\__/\_,_/_/_/_/
#										 \___/                                                 

#								DO NOT ABUSE THIS FREE CODE LIKE YOU ABUSED MY BOTNET CODE.
#								TAKING THIS CODE, CHANGING THE ASTHETICS, AND CALLING IT YOURS WITHOUT PROPER CREDIT IS NOT DEVELOPING.
								
#								THIS CODE IS FOR YOUR BENEFIT. DO NOT RUIN IT FOR EVERYONE ELSE.
										 										 
#								This version does not require python3.* because it does not support job Queue
#								Most features of this RAT server and RAT client have been excluded from the Lite version
								
#								THIS VERSION DOES NOT SUPPORT MULTI-CLIENT OR MULTI-VICTIM
#								ONLY ONE TARGET AND ONE USER PER SERVER (unless you can figure out how to recode this yourself)
								
#								THIS TARGET-CLIENT VERSION DOES NOT INCLUDE THE DIRECTORY TRAVERSAL CAPABILITIES FROM THE PRIVATE VERSION
#								THIS TARGET-CLIENT WILL NOT HIDE ITSELF IN THE FILE SYSTEM
								
#								CONTACT @the.red.team TO HAVE THE TARGET-CLIENT RECODED AND SENT TO YOU (client source code is private)
#								THIS SERVER WILL NOT WORK WITHOUT THE PROPER FUNCTIONING TARGET-CLIENT
#								(command server IP and PORT are hard coded with C++)
